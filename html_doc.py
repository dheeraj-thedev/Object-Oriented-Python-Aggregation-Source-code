class Tag(object):
    ...
    def __init__(self, name, contents):
        self.start_tag = '<{}>'.format(name) #<div>
        self.end_tag = '</{}>'.format(name) #</div>
...
if __name__ == '__main__':
    ...
    new_body = Body()
    new_body.add_tag('h1', "I created this using python isn't it cool")
    new_body.add_tag('h2', 'Aggregation')
    new_body.add_tag('button', "Click me ")
...
#implementing IO with files 
    with open('D:\\Mukesh-Python.html', 'w') as test_doc:
